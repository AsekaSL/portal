  ...
  <div class="login-container">
      ...
      <fieldset class="login-fieldset">
          ...
          <form class="login-form" action="index.php?page=login" method="post">
              ...
              <input class="login-input" type="text" id="login-username" name="username" required>

              <label class="login-label" for="login-password">Password:</label>
              <input class="login-input" type="password" id="login-password" name="password" required>
