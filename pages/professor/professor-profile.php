        ...
        <form id="profileForm" class="profile-form" style="display: none;">
            ...
            <div class="photo-section">
                <div class="photo-container">
                    <img id="profilePhoto" src="https://via.placeholder.com/150" alt="Professor Photo"
                        class="profile-photo">
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-group full-width">
                        ...
                        <input type="text" id="degree" name="degree" placeholder="e.g., Ph.D. in Computer Science"
                            disabled>
                    </div>

                    <div class="form-group full-width">
                        <label for="specialization">Specialization</label>
                        <textarea id="specialization" name="specialization" rows="3" placeholder="Areas of expertise..."
                            disabled></textarea>
                    </div>

                    <div class="form-group full-width">
                        <label for="publications">Publications</label>
                        <textarea id="publications" name="publications" rows="4" placeholder="List of publications..."
                            disabled></textarea>
                    </div>

                    <div class="form-group full-width">
                        <label for="coursesTaught">Courses Taught</label>
                        <textarea id="coursesTaught" name="coursesTaught" rows="3" placeholder="List of courses..."
                            disabled></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="form-grid">
                    <div class="form-group full-width">
                        ...
                        <textarea id="address" name="address" rows="3" placeholder="Complete address..."
                            disabled></textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="emergencyPhone" name="emergencyPhone"
                            placeholder="Emergency contact phone" disabled>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea id="changeReason" rows="4"
                        placeholder="Please provide a detailed reason for this change request..." required></textarea>
                </div>
                <div class="form-group">
